...
#             .button {{ background: #4A90E2; color: white; padding: 12px 30px; text-decoration: none; 
...
#             <div class="content">
#                 <p>Hi {name},</p>
#                 <p>The appointment scheduled with Dr. {doctor_name} on {appointment_time} has been canceled by the {canceled_by}.</p>
#                 <p>You can book a new appointment anytime through the app.</p>
#             </div>
#             <div class="footer">
#                 <p>TeleMed - Your Health, Our Priority</p>
...
#             .content {{ background: #f9f9f9; padding: 30px; }}
#             .button {{ background: #F39C12; color: white; padding: 12px 30px; text-decoration: none; 
#                        display: inline-block; border-radius: 5px; margin: 20px 0; }}
#             .footer {{ text-align: center; padding: 20px; color: #666; font-size: 12px; }}
#         </style>
#     </head>
...
#             <div class="content">
#                 <p>Hi {name},</p>
#                 <p>This is a reminder that you have an appointment in <strong>{hours_until} hour(s)</strong>.</p>
#                 <p><strong>Doctor:</strong> Dr. {doctor_name}</p>
#                 <p><strong>Date & Time:</strong> {appointment_time}</p>
#                 <p>Please be ready to join the video call a few minutes before the scheduled time.</p>
#             </div>
